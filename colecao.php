...
<html lang="en">
  ...
  <!-- Fim do menu -->
      ...
      <div class="album py-5 bg-light"> <!-- Inicio do resumo -->
        <div class="container">

          <div class="row"><!-- Elemento que envolve as colunas -->
            <div class="col-md-4"><!-- Desloca o elemento .col-md-4, por quatro colunas. -->
              <div class="card mb-4 shadow-sm"> <!-- container de conteúdo flexível e extensível -->
                <img class="card-img-top" src="imagens/cate1.jpg" alt="Card image cap"><!-- coloca a imagem dentro do card -->
                <div class="card-body"> <!-- textos e botões de comprar e ver -->
                  <h5>Caneca de Casal</h5>
                  <p class="card-text" id="texto">Pode ser personalizada com sua foto, da sua familia, do seu animalzinho de estimação, da sua empresa e de quem você quiser. São estampadas em qualidade fotográfica, cores brilhantes de excelente qualidade e acabamento impecável.!</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <a href="principal.php"><button type="button" class="btn btn-sm btn-outline-secondary">Ver</button></a>  
                      <a href="carrinho.php"><button type="button" class="btn btn-sm btn-outline-secondary">Comprar</button></a>
                    </div>
                    <small class="text-muted">$36,90</small><!-- preço do produto -->
                  </div>
                </div>
              </div>
            </div>
            <div class="col-md-4">
              <div class="card mb-4 shadow-sm">
                <img class="card-img-top" src="imagens/cate2.jpg" alt="Card image cap">
                <div class="card-body">
                  <h5>Caneca Girassol</h5>
                  <p class="card-text" id="texto" >Pode ser personalizada com sua foto, da sua familia, do seu animalzinho de estimação, da sua empresa e de quem você quiser. São estampadas em qualidade fotográfica, cores brilhantes de excelente qualidade e acabamento impecável.</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
            ...
            <div class="col-md-4">
              <div class="card mb-4 shadow-sm">
                <img class="card-img-top" src="imagens/cate3.jpg" alt="Card image cap">
                <div class="card-body">
                  <h5>Caneca Dia das Mães</h5>
                  <p class="card-text" id="texto">Pode ser personalizada com sua foto, da sua familia, do seu animalzinho de estimação, da sua empresa e de quem você quiser. São estampadas em qualidade fotográfica, cores brilhantes de excelente qualidade e acabamento impecável.</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <button type="button" class="btn btn-sm btn-outline-secondary">Ver</button>
            ...
            <div class="col-md-4">
              <div class="card mb-4 shadow-sm">
                <img class="card-img-top" src="imagens/cate4.jpg" alt="Card image cap">
                <div class="card-body">
                  <h5>Caneca Doutor</h5>
                  <p class="card-text" id="texto">Pode ser personalizada com sua foto, da sua familia, do seu animalzinho de estimação, da sua empresa e de quem você quiser. São estampadas em qualidade fotográfica, cores brilhantes de excelente qualidade e acabamento impecável.</p>
                  <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="col-md-4">
              <div class="card mb-4 shadow-sm">
                <img class="card-img-top" src="imagens/cate5.jpg"alt="Card image cap">
                <div class="card-body">
                  <h5>Caneca Engenharia</h5>
                  <p class="card-text" id="texto">Pode ser personalizada com sua foto, da sua familia, do seu animalzinho de estimação, da sua empresa e de quem você quiser. São estampadas em qualidade fotográfica, cores brilhantes de excelente qualidade e acabamento impecável.</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <button type="button" class="btn btn-sm btn-outline-secondary">Ver</button>
            ...
            <div class="col-md-4">
              <div class="card mb-4 shadow-sm">
                <img class="card-img-top" src="imagens/cate6.jpg" alt="Card image cap">
                <div class="card-body">
                  <h5>Caneca Stich</h5>
                  <p class="card-text" id="texto">Pode ser personalizada com sua foto, da sua familia, do seu animalzinho de estimação, da sua empresa e de quem você quiser. São estampadas em qualidade fotográfica, cores brilhantes de excelente qualidade e acabamento impecável.</p>
                  <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="col-md-4">
              <div class="card mb-4 shadow-sm">
                <img class="card-img-top" src="imagens/cate7.jpg" alt="Card image cap">
                <div class="card-body">
                  <h5>Caneca Love you</h5>
                  <p class="card-text" id="texto">Pode ser personalizada com sua foto, da sua familia, do seu animalzinho de estimação, da sua empresa e de quem você quiser. São estampadas em qualidade fotográfica, cores brilhantes de excelente qualidade e acabamento impecável.</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <button type="button" class="btn btn-sm btn-outline-secondary">Ver</button>
            ...
            <div class="col-md-4">
              <div class="card mb-4 shadow-sm">
                <img class="card-img-top" src="imagens/cate8.jpg" alt="Card image cap">
                <div class="card-body">
                  <h5>Caneca Dinda</h5>
                  <p class="card-text" id="texto">Pode ser personalizada com sua foto, da sua familia, do seu animalzinho de estimação, da sua empresa e de quem você quiser. São estampadas em qualidade fotográfica, cores brilhantes de excelente qualidade e acabamento impecável.</p>
                  <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="col-md-4">
              <div class="card mb-4 shadow-sm">
                <img class="card-img-top" src="imagens/cate9.jpg" alt="Card image cap">
                <div class="card-body">
                  <h5>Caneca Velhinhos</h5>
                  <p class="card-text" id="texto">Pode ser personalizada com sua foto, da sua familia, do seu animalzinho de estimação, da sua empresa e de quem você quiser. São estampadas em qualidade fotográfica, cores brilhantes de excelente qualidade e acabamento impecável.</p>
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="btn-group">
                      <button type="button" class="btn btn-sm btn-outline-secondary">Ver</button>
