    ...
    <header>
      ...
      <div class="container marketing">
        ...
        <div class="row featurette">
          <div class="col-md-7">
            <h2 class="featurette-heading">Caneca personalizada - <span class="text-muted">Spotify</span></h2></br>
            <h6>Caneca de cerâmica branca personalizada - Tema: Dia dos Namorados</h6>
            <form action="">
                <label for="fname">Música:</label><br>
                <input type="text" id="fname" name="fname"><br>

                <br>
                <h4>Cor da Caneca:</h4>
                <input type="radio" id="Branca" name="cor_caneca" value="Branca">
                <label for="html">Branca</label><br>
                <input type="radio" id="Preta" name="cor_caneca" value="Preta">
                <label for="html">Preta</label><br>
                <input type="radio" id="Amarela" name="cor_caneca" value="Amarela (Pastel)">
                <label for="html">Amarela (Pastel)</label><br>
                <input type="radio" id="Rosa" name="cor_caneca" value="Rosa (Pastel)">
                <label for="html">Rosa (Pastel)</label><br>
                <input type="radio" id="Azul" name="cor_caneca" value="Azul (Pastel)">
                <label for="html">Azul (Pastel)</label><br>
                <br>
                <h4>Envie a Foto</h4>
                <button type="button" class="btn btn-sm btn-outline-secondary">Selecionar Arquivo</button>
                <br>
                <br>
            </form>
          ...
          <div class="col-md-5">
            <img class="featurette-image img-fluid mx-auto" src="imagens/caneca3.jpg"  alt="Generic placeholder image">
          </div>
        </div>
