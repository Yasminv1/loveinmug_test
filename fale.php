...
<title>Centro de Atendimento</title>
...
<div class="text-center">
  <img src="imagens/atendimento.png" alt="IMG"> 
  <form class="form-atend">

    <h1 class="atendimento">Atendimento</h1>
<!-- Nome -->
    <label for="nome"> <span class="text-muted"></span></label>
    <label for="inputNome" class="sr-only">Nome</label>
    <input type="nome" id="inputNome" class="form-control" placeholder="Nome" required autofocus> <!-- Especifica que um elemento deve receber automaticamente o foco quando a página é carrega -->
<!-- Email -->
...
<!-- Mensagem -->
    <label for="mensagem"> <span class="text-muted"></span></label>
    <label for="inputMensagem" class="sr-only">Mensagem</label>
    <input type="mensagem" id="inputMensagem" class="form-control" placeholder="Mensagem" required autofocus>

    <div class="checkbox mb-3">
        <label>
          <input type="checkbox" value="remember-me"> Receber Notificação
        </label>
